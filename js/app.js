...
$(function() {
    ...
    var signupValidationSettings = {
	    ...
	    messages: {
	    	firstname: "Будь ласка, введіть ваше повне ім'я",
	    	lastname: "Будь ласка, введіть ваше повне ім'я",
	        email: {
	            required: "Будь ласка, введіть email",
                email: "Будь ласка, введіть існуючий email"
	        },
	        password: {
                required: "Будь ласка, введіть пароль",
                password:  "Будь ласка, введіть пароль",
	        	minlength: "Введіть пароль, що містить більше 8 символів"
	        },
	        retype_password: {
                required: "Будь ласка, введіть пароль",
                password:  "Будь ласка, введіть пароль",
            ...
            agree: "Будь ласка, погодьтесь із правилами"
	    },
